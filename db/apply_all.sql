-- TrustCare — the whole schema as one script.
-- Generated by concatenating db/migrations/*.sql in order, for pasting into the
-- Supabase SQL editor when no database credential is at hand. Do not edit by hand:
